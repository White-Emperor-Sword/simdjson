...
public:
  ...
  really_inline simdjson_result<ondemand::value> operator[](std::string_view key) noexcept;
...
protected:
  ...
  really_inline ondemand::value as_value() noexcept;
  ...
  friend void logger::log_ondemand_line(T &json, const char *title_prefix, const char *title, const char *detail);
};
...
template<>
struct simdjson_result<SIMDJSON_IMPLEMENTATION::ondemand::json> : public internal::simdjson_result_base<SIMDJSON_IMPLEMENTATION::ondemand::json> {
public:
  really_inline simdjson_result(SIMDJSON_IMPLEMENTATION::ondemand::json &&value) noexcept; ///< @private
  really_inline simdjson_result(SIMDJSON_IMPLEMENTATION::ondemand::json &&value, error_code error) noexcept; ///< @private
...
protected:
  really_inline simdjson_result<SIMDJSON_IMPLEMENTATION::ondemand::value> as_value() noexcept;
};
